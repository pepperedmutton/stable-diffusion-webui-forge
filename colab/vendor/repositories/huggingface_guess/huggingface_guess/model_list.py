...
class Lumina2(BASE):
    huggingface_repo = "Alpha-VLLM/Lumina-Image-2.0"
    ...
    def clip_target(self, state_dict={}):
        ...
        if "{}gemma2_2b.transformer.model.embed_tokens.weight".format(pref) in state_dict:
            result["gemma2_2b"] = "text_encoder"
        elif "{}gemma2_2b.model.embed_tokens.weight".format(pref) in state_dict:
            result["gemma2_2b"] = "text_encoder"
        elif "{}gemma2_2b.embed_tokens.weight".format(pref) in state_dict:
            result["gemma2_2b"] = "text_encoder"
...
class Anima(Flux):
    huggingface_repo = 'CircleStone/Anima'
...
class AnimaSchnell(Anima):
    # Keep the same repo by default. If a dedicated Schnell repo exists, this can be overridden.
    huggingface_repo = 'CircleStone/Anima'
...
class AnimaCosmos(BASE):
    huggingface_repo = 'CircleStone/Anima'

    unet_config = {
        "image_model": "anima_cosmos",
    }
    ...
    def clip_target(self, state_dict={}):
        ...
        if "{}gemma2_2b.model.embed_tokens.weight".format(pref) in state_dict:
            result['gemma2_2b'] = 'text_encoder'
        return result


models = [Stable_Zero123, SD15_instructpix2pix, SD15, SD20, SD21UnclipL, SD21UnclipH, SDXL_instructpix2pix, SDXLRefiner, SDXL, SSD1B, KOALA_700M, KOALA_1B, Segmind_Vega, SD_X4Upscaler, Stable_Cascade_C, Stable_Cascade_B, SV3D_u, SV3D_p, SD3, Lumina2, StableAudio, AuraFlow, HunyuanDiT, HunyuanDiT1, Flux, FluxSchnell, Anima, AnimaSchnell, AnimaCosmos]
