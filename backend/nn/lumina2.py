...
class IntegratedLumina2Transformer2DModel(Lumina2Transformer2DModel):
    def forward(self, x, timestep, context, attention_mask=None, attention_kwargs=None, **kwargs):
