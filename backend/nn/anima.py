# Single File Implementation of Anima with aggressive optimizations, Copyright Forge 2024
# If used outside Forge, only non-commercial use is allowed.
# See also https://github.com/black-forest-labs/Anima
...
def timestep_embedding(t, dim, max_period=10000, time_factor=1000.0):
    ...
    # TODO: Once A trainer for Anima get popular, make timestep_embedding consistent to that trainer

    # Do not block CUDA steam, but having about 1e-4 differences with Anima official codes:
...
class IntegratedAnimaTransformer2DModel(nn.Module):
